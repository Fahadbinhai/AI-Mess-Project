...
export default function PublicSheetView({ params }: { params: Promise<{ sheetId: string }> }) {
  ...
  return (
    <div className="page-container" style={{ maxWidth: '1800px', margin: '0 auto', padding: '1.5rem 1rem' }}>
      {/* Top Banner Header */}
      <div className="glass-panel" style={{ background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, rgba(24, 24, 27, 0.9) 100%)', borderLeft: '4px solid #8b5cf6', marginBottom: '1.75rem' }}>
      ...
      <div className="glass-panel p-4" style={{ marginBottom: '1.75rem' }}>
      ...
      <div className="glass-panel overflow-hidden" style={{ marginBottom: '1.75rem' }}>
