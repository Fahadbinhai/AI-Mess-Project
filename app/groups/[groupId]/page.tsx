...
export default function GroupDashboard({ params }: { params: Promise<{ groupId: string }> }) {
  ...
  return (
    <div className="page-container">
      ...
      {canManage && (
        <div className="glass-panel p-4 border-l-4 border-purple-500" style={{ marginBottom: '1.75rem' }}>
      ...
      {/* Main layout */}
      <div className="two-col-grid" style={{ gap: '1.75rem' }}>
        {/* Left column */}
        <div className="flex flex-col" style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          {/* Monthly Sheets */}
          <section className="glass-panel">
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2" style={{ marginBottom: '1.25rem' }}>
            ...
            {sheets.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {sheets.map(sheet => (
                  <div key={sheet._id} className="glass-panel p-4 flex flex-col justify-between hover:border-purple-500/50 transition-colors" style={{ minHeight: '125px' }}>
                    <div>
                    ...
                    <div className="flex items-center justify-between mt-4 pt-3 border-t border-zinc-800/80 gap-2" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(255, 255, 255, 0.08)' }}>
          ...
          {/* Members */}
          <section className="glass-panel">
            <h2 className="text-base font-bold text-white mb-4" style={{ marginBottom: '1rem' }}>
            ...
            {canManage && (
              <div style={{ marginTop: '1.5rem', paddingTop: '1.25rem', borderTop: '1px solid rgba(255, 255, 255, 0.08)' }}>
                <h3 className="text-sm font-bold text-zinc-300 mb-3" style={{ marginBottom: '0.75rem' }}>Add New Member</h3>
